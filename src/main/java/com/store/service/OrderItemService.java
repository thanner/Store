...
public class OrderItemService {
    ...
    @Autowired
    public OrderItemService(OrderItemRepository orderItemRepository, OrderService orderService, ProductService productService, NonNullPropertiesCopier copier) {
    ...
    public OrderItem updateById(Integer customerId, Integer orderId, Integer orderItemId, OrderItem orderItem) {
        ...
        copier.copyNonNullProperties(orderItem, persisted);
        return persisted;
    }
